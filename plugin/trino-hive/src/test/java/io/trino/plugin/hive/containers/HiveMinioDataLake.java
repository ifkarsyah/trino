        ...
        implements AutoCloseable
{
    ...
    {
        this(bucketName, ImmutableMap.of(), HiveHadoop.DEFAULT_IMAGE);
    }
    ...
    public HiveMinioDataLake(String bucketName, Map<String, String> hiveHadoopFilesToMount, String hiveHadoopImage)
    {
        ...
        Map<String, String> defaultHiveHadoopResourcesToMount = new HashMap<>(Map.of(
                "/etc/hadoop/conf/core-site.xml", getPathFromClassPathResource("hive_minio_datalake/hive-core-site.xml")));
        defaultHiveHadoopResourcesToMount.putAll(hiveHadoopFilesToMount);
        hiveHadoopBuilder.withFilesToMount(defaultHiveHadoopResourcesToMount);
